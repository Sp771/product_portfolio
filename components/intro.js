...
export default function Intro() {
  ...
  <span className="text-4xl md:text-5xl font-semibold text-gray-600">Product Leader</span>
</h1>
      ...
      <Image title={"lisafeets"} src={"/assets/posts/authors/annie.svg"} height={700} width={700}
      />
    </section>
  )
}
