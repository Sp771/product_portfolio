...
const Pepper = () => {
  return (
    <Layout>
      <Head>
        <title>Sydne Pittman | Pepper</title>
        <meta name="description" content="Follow Pepper Pittman on her big adventures, exploring the world with small legs but a mighty spirit." />
      </Head>

      <Container>
         {/* Return Link */}
         <a href="/about" className="text-sm text-[#4056a1] flex items-center underline mb-4">
          {/* Back arrow icon */}
